/*
  ...
  - Added the required column `localidad` to the `Publicacion` table without a default value. This is not possible if the table is not empty.
  - Added the required column `esInmobiliaria` to the `Usuario` table without a default value. This is not possible if the table is not empty.
  - Added the required column `localidad` to the `Usuario` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_Usuario" (
    ...
    "sitioWeb" TEXT,
    "imagenLogo" TEXT,
    "esInmobiliaria" BOOLEAN NOT NULL,
    "localidad" TEXT NOT NULL,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
