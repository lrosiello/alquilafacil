/*
  ...
  - You are about to drop the column `publicacionDetalleId` on the `Foto` table. All the data in the column will be lost.
  - You are about to drop the column `tipo` on the `Foto` table. All the data in the column will be lost.
